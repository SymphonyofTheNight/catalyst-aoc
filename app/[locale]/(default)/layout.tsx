...
export default async function DefaultLayout({ children, params: { locale } }: Props) {
  ...
  return (
    <>
      ...
      <main className={cn("flex-1 px-4 2xl:container sm:px-10 lg:px-12 2xl:mx-auto 2xl:px-0 xxs:!px-0", 'lg:max-w-none w-full lg:p-0', montserrat.className, raleway.className)}>
