...
const Button = forwardRef<ElementRef<'button'>, Props>(
  (
    ...
    return (
      <Comp
        className={cn(
          'relative flex w-full items-center justify-center border-2 border-[#132448] py-[10px] py-2.5 text-base font-[400] leading-6 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/20 disabled:border-gray-400 capitalize',
          variant === 'primary' &&
