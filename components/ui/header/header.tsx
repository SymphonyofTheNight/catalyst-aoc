...
const Header = async ({
  ...
  return (
    <div className={cn('relative', className)}>
      <header className="flex h-[92px] items-center justify-between gap-1 overflow-y-visible bg-black px-4 2xl:container sm:px-10 lg:gap-8 lg:px-12 2xl:mx-auto 2xl:px-0">
